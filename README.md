...
|                                   |                                                                                                                                                                                      |
| :-------------------------------- | :----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| abstraction                       | A core principle of object-oriented programming; the practice of hiding complex implementation details and exposing only the essential functionalities to simplify code interaction. |
