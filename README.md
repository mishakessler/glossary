...
|                                   |                                                                                                                                                                                      |
| :-------------------------------- | :----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| abstraction                       | A core principal of object-oriented programming, the practice of hiding complex implementation details and exposing only the essential functionalities to simplify code interaction. |
...
| encapsulation             | A core principal of object-oriented programming, the practice of restricting direct access to certain object properties and methods, allowing controlled modification and protecting data integrity. |
...
| polymorphism                 | A core principal of object-oriented programming, the practice of enabling different objects to respond uniquely to the same method or function call, creating more flexibility and allowing code reuse. |
